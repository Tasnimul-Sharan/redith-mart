        ...
        <div className="flex flex-wrap xl:flex-nowrap gap-10 xl:gap-19 xl:justify-between pt-17.5 xl:pt-22.5 pb-10 xl:pb-15">
          <div className="max-w-[330px] w-full">
            ...
            <p className="text-sm text-gray-500 mt-2">
              Trusted Online Shopping in Bangladesh
            </p>

            <div className="flex items-center gap-6 mt-7.5">
              <a
                href="https://www.facebook.com/redithmart"
                aria-label="Facebook"
                className="text-gray-8 hover:text-primary transition-all transform duration-500 text-2xl"
              >
                <FaFacebook />
              </a>

              <a
                href="https://twitter.com/redithmart"
                aria-label="Twitter"
                className="text-gray-8 hover:text-primary transition-all transform duration-500 text-2xl"
              >
                <FaTwitter />
              ...
              <a
                href="https://www.instagram.com/redithmart"
        ...
        <div className="custom-container w-full mx-auto">
          <div className="flex gap-5 flex-wrap items-center justify-between">
            <p className="text-dark font-medium">
              &copy; {year}. All rights reserved by Redith Group.
            </p>
